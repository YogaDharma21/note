...
export function Sidebar({
    ...
    const renderNotebook = (notebook: Notebook, level = 0) => {
        ...
        const isDragOver =
            dragOverItem?.type === "notebook" &&
            dragOverItem.id === notebook.id;
        ...
        return (
            <div key={notebook.id}>
                <div
                    ...
                    } // Disable drag if editing, move, or deleting
                    onDragStart={(e) =>
                        handleDragStart(e, "notebook", notebook.id)
                    }
                    onDragOver={(e) =>
                        handleDragOver(e, "notebook", notebook.id)
                    }
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem
                                    ...
                                    disabled={
                                        isProcessingMove ||
                                        isThisNotebookDeleting
                                    } // Disable if move or delete is processing
                                >
                                    {isThisNotebookDeleting ? (
                        ...
                        {notebookNotes.map((note) => {
                            ...
                            return (
                                <div
                                    ...
                                    draggable={
                                        !isProcessingMove && !isThisNoteDeleting
                                    } // Disable drag if move or deleting
                                    onDragStart={(e) =>
                                ...
                                >
                                    <Button
                                        ...
                                        disabled={
                                            isProcessingMove ||
                                            isThisNoteDeleting
                                        } // Disable button if move or delete is processing
                                    >
    ...
    return (
        <div
            ...
            onDragOver={(e) => {
                if (isProcessingMove || isDeletingNotebook || isDeletingNote)
                    return; // Prevent drag over if another operation is in progress
                e.preventDefault();
                e.dataTransfer.dropEffect = "move";
            }}
            onDrop={(e) => {
                if (isProcessingMove || isDeletingNotebook || isDeletingNote)
                    return; // Prevent drop if another operation is in progress
                handleDropOnRoot(e);
            }}
        >
            <div className="p-2">
